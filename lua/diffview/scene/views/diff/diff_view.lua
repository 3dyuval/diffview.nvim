...
local FileDict = lazy.access("diffview.adapters.vcs.file_dict", "FileDict") ---@type FileDict|LazyModule
...
local GitAdapter = lazy.access("diffview.adapters.vcs.adapters.git", "GitAdapter") ---@type GitAdapter|LazyModule
